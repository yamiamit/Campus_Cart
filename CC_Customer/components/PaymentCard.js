...
const PaymentCard = props => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.HeadText}>Payment gateway</Text>
      <View style={styles.body}>
        <View style={styles.option} key={1}>
          <View style={styles.option1}>
            <Image source={Gpay} style={styles.logo} />
            <View style={styles.id}>
              <Text style={styles.Text1}>Google Pay</Text>
              <Text style={styles.Text2}>{props.id1}</Text>
            </View>
          </View>
          <RadioButton
            key={1}
        ...
        <View style={styles.option} key={2}>
          <View style={styles.option1}>
            ...
            <View style={styles.id}>
              ...
              <Text style={styles.Text2}>{props.id2}</Text>
            </View>
          </View>
          <RadioButton
            key={2}
